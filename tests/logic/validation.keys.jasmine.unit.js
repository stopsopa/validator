...
it("key - flat", (done) => {
  validator("test", new Length(6)).then(
    (errors) => {
      errors = errors.getRaw();

      expect(errors).toEqual([[undefined, "This value should have exactly 6 characters.", "TOO_SHORT_ERROR", "test"]]);
...
it("key - invalid collection, 1st level key", (done) => {
  validator(
    ...
    (errors) => {
      ...
      expect(errors).toEqual([["test", "This value should have exactly 6 characters.", "TOO_SHORT_ERROR", "abcde"]]);
...
it("key - invalid collection, 2st level key", (done) => {
  validator(
    ...
    (errors) => {
      ...
      expect(errors).toEqual([
        ["test.test2", "This value should have exactly 6 characters.", "TOO_SHORT_ERROR", "abcde"],
      ]);
...
it("key - invalid collection, 3st level key - behind Require 5", (done) => {
  validator(
      ...
      test: new Required([
        new Collection({
          test2: new Collection({
            test3: new Required([new Length(6)]),
          }),
        }),
      ]),
    })
    ...
    (errors) => {
      ...
      expect(errors).toEqual([
        ["test.test2.test3", "This value should have exactly 6 characters.", "TOO_SHORT_ERROR", "abcde"],
      ]);
...
it("key - add prefix", (done) => {
  validator(
    ...
    (errors) => {
      ...
      expect(errors).toEqual([
        ["pre.fix.a", "This value should have exactly 80 characters.", "TOO_SHORT_ERROR", "te"],
        ["pre.fix.test.test2.test3", "This value should have exactly 6 characters.", "TOO_SHORT_ERROR", "abcde"],
      ]);
...
it("key - add prefix (empty string)", (done) => {
  validator(
    ...
    (errors) => {
      ...
      expect(errors).toEqual([
        ["a", "This value should have exactly 80 characters.", "TOO_SHORT_ERROR", "te"],
        ["test.test2.test3", "This value should have exactly 6 characters.", "TOO_SHORT_ERROR", "abcde"],
      ]);
