...
it("Callback - main arg", (done) => {
  ...
  validator(
    ...
    (errors) => {
      ...
      expect(errors).toEqual([[undefined, "Custom message: not equal.", "CALLBACK_5", "test"]]);
...
it("Callback - not promise", (done) => {
  validator(
    "test",
    new Callback((value, context, path, extra) => {
      if (value.length !== 5) {
        context
          .buildViolation("Custom message: {{ callback }}.")
          .atPath(path)
    ...
    (errors) => {
      ...
      expect(raw).toEqual([[undefined, "Custom message: not equal.", "CALLBACK_5", "test"]]);
...
it("Callback - race 1", (done) => {
  validator(
    ...
    (errors) => {
      ...
      expect(raw).toEqual([
        [undefined, "Custom message 1: not equal 1.", "CALLBACK_15", "tes"],
        [undefined, "Custom message 2: not equal 2.", "CALLBACK_25", "tes"],
      ]);
